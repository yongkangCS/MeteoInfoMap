...
//        this.jLabel_Variable.setLocation(this.jComboBox_Variable.getX() - this.jLabel_Variable.getWidth() - 4, this.jLabel_Variable.getY());
    ...
    private void initComponents() {
        ...
        jButton_CreateAnimatorFile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/Animation-2.png"))); // NOI18N
        ...
        jButton_DrawSetting.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/TSB_DrawSetting.Image.png"))); // NOI18N
        ...
        jButton_Setting.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/Setting-1.png"))); // NOI18N
        ...
        jButton_SectionPlot.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/chart-5.png"))); // NOI18N
        ...
        jButton_1DPlot.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/chart.png"))); // NOI18N
                ...
                if (this.jComboBox_Time.getItemCount() > 1) {
                    SwingWorker worker = new SwingWorker<String, String>() {
                        ...
                        protected String doInBackground() throws Exception {
                            jButton_Animator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/stop.png")));
                            _isRunning = true;
                            _useSameLegendScheme = true;
                            _useSameGridInterSet = true;
                            for (int i = 0; i < jComboBox_Time.getItemCount(); i++) {
                                if (!_enableAnimation) {
                                    ...
                                    _isRunning = false;
                                    jButton_Animator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/meteoinfo/resources/animation-1.png")));
                                    return "";
                                }
