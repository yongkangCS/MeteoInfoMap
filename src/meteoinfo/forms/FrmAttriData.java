 ...
 * @author Yaqiang Wang
 */
public class FrmAttriData extends javax.swing.JDialog {
     ...
     */
    public FrmAttriData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmAttriData dialog = new FrmAttriData(new javax.swing.JFrame(), true);
